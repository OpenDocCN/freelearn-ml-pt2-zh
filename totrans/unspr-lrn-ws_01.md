...
1.  在 macOS 上安装 Anaconda 非常用户友好。访问下载页面获取安装可执行文件，网址为[https://www.anaconda.com/distribution/#download-section](https://www.anaconda.com/distribution/#download-section)。
